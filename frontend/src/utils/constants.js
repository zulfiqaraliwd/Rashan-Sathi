...
export const STATUS_LABELS = {
  requested: { en: 'Requested', color: 'blue' },
  accepted: { en: 'Accepted', color: 'green' },
  shopping: { en: 'Shopping', color: 'yellow' },
  delivered: { en: 'Delivered', color: 'purple' },
  paid: { en: 'Paid', color: 'green' },
  cancelled: { en: 'Cancelled', color: 'red' },
  rejected: { en: 'Rejected', color: 'red' },
  disputed: { en: 'Disputed', color: 'red' },
};
